...
def main():
    ...
    # 保存模型
    model.save_model(f"{base_dir}/mscdae_v3_models")
    
    # 在测试样本上进行检测
    model.test_batch_images(f"{base_dir}/data/test", f"{base_dir}/data/mscdae3_test1_results")
    test_batch_images_with_visualization(model, f"{base_dir}/data/test", output_dir=f"{base_dir}/data/mscdae3_test2_results", threshold=0.01)
